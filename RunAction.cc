...
man->CreateNtuple("EnergyEdep","Energy deposition with hard mode");
 man->CreateNtupleDColumn("Edep0");
 man->CreateNtupleDColumn("Edep1");
man->CreateNtupleDColumn("Edep2");
man->CreateNtupleDColumn("Edep3");
man->CreateNtupleDColumn("Edep4");
man->CreateNtupleDColumn("Edep5");
man->CreateNtupleDColumn("Edep6");
man->CreateNtupleDColumn("Edep7");
man->CreateNtupleDColumn("Edep8");
man->CreateNtupleDColumn("Edep9");
man->CreateNtupleDColumn("Edep10");
man->CreateNtupleDColumn("Edep11");
man->CreateNtupleDColumn("Edep12");
man->CreateNtupleDColumn("Edep13");
man->CreateNtupleDColumn("Edep14");
man->CreateNtupleDColumn("Edep15");
man->CreateNtupleDColumn("Edep16");
